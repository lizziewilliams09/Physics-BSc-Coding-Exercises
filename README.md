...
* **Gauss–Seidel Over-Relaxed Solver**: Extends the Poisson solver using the Gauss–Seidel Successive Over-Relaxation (SOR) method to improve convergence efficiency. Determines the optimal relaxation parameter ω by measuring iteration counts across values of ω. Demonstrates understanding of numerical optimisation, performance benchmarking, and iterative algorithm tuning.
